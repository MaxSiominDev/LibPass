...
import dev.maxsiomin.libpass.annotations.ToastDuration
import dev.maxsiomin.libpass.database.LibpassDao
import dev.maxsiomin.libpass.database.LibpassDatabase
import dev.maxsiomin.libpass.extensions.getDefaultSharedPrefs
...
class UiActionsImpl(override val context: Context) : UiActions {
    ...
    override val dao = LibpassDatabase.getInstance(context).libpassDao()
